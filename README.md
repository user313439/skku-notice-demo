...
- 제목, 본문, 태그 검색과 추천 검색어, 학과, 카테고리, 읽음, 북마크, 마감 상태 필터
- 홈과 검색 화면의 조건 필터 접기/펼치기
- 공지 상세와 저장함/D-Day 화면에서 공지별 마감 알림 시점 선택
- 키워드 규칙 기반 목 알림 생성
...
- 성균관대학교 소프트웨어학과 공지사항 페이지에서 2026년 5월 22일 기준 확인한 상단 공지 흐름을 주요 목 데이터에 반영했습니다.
